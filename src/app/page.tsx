          ...
          */}
          <div className="relative flex w-full items-center space-x-2">
            <input
              ...
              className="flex h-12 w-full rounded-md border border-gray-200 bg-white px-4 py-2 text-lg text-gray-900 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              value={query}
